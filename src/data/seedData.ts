...
export const SEED_USERS: User[] = [
  // Global Administrator
  {
    ...
    department: 'Conference Operations & Facilities',
  ...
  // CCEC IT Support
  {
    ...
    username: 'it.ccec',
    password: 'password123',
    fullName: 'David Evans (CCEC IT Lead)',
    email: 'david.thorne@ccec.internal',
    role: 'IT',
    businessUnitId: 'bu-ccec',
    departmentId: 'dept-ccec-av',
    department: 'Audio Visual & Event Staging',
  ...
  // FNB IT Support
  {
    ...
    department: 'Point-of-Sale (POS) & Cashiers',
  ...
  // HOTEL IT Support
  {
    ...
    department: 'Guest Wi-Fi & In-Room Entertainment',
  ...
  // KLBS IT Support
  {
    ...
    department: 'Smart Building IoT & Access Control',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
    mustChangePassword: false,
  ...
  // KLW IT Support
  {
    ...
    department: 'Medical IoT & Diagnostic Telemetry',
  ...
  // UOA HQ IT Support
  {
    ...
    department: 'Cybersecurity & Corporate Governance',
  ...
  },
  {
    ...
    department: 'Floor Service & Banquet Management',
  ...
  // HOTEL Staff Users
  {
    ...
    department: 'Front Office & Guest Check-In (Opera PMS)',
  ...
  },
  {
    ...
    department: 'Housekeeping Mobility & Guest Request Routing',
  ...
  // KLBS Staff Users
  {
    ...
    department: 'Commercial Leasing & Property Management',
    avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
    mustChangePassword: false,
  ...
  },
  {
    ...
    department: 'Retail Mall Management & Footfall Signage',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    mustChangePassword: true, // First-time user pending password change
  ...
  // KLW Staff Users
  {
    ...
    department: 'Patient Check-In & Smart Registration',
  ...
  },
  {
    ...
    department: 'Healthcare Facilities & Telemetry',
  ...
  // UOA HQ Staff Users
  {
    ...
    department: 'Enterprise ERP & Financial Systems',
    avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80',
    mustChangePassword: false,
